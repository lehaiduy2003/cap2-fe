            ...
            try {
                ...
                if (contract.tenantId) {
                    ...
                    if (tenantResponse.ok) {
                        ...
                        if (
                            tenantData.usersList &&
                            tenantData.usersList.length > 0
                        ) {
                ...
                if (contract.roomId) {
                    const roomResponse = await fetch(
                        `${BASE_API_URL}/api/rooms/${contract.roomId}`,
                        {
                            headers: {
                                Authorization: `Bearer ${localStorage.getItem('authToken')}`,
                            },
                        ...
                        {roomInfo ? (
                            <div className='room-info'>
                                ...
                                <p>
                                    ...
                                    {roomInfo.price?.toLocaleString()} VNĐ/Tháng
                                </p>
                            </div>
                        ) : (
                    ...
                    <div className='invoice-section'>
                        ...
                        <div className='contract-info'>
                            ...
                            <p>
                                ...
                                {invoice.pricePerMonth
                                    ? invoice.pricePerMonth.toLocaleString()
                                    : ''}{' '}
                                VNĐ
                            </p>
                            <p>
